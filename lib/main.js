...
// the toolbar button is a toogle button that triggers a change event
...
// when the panel hides, set the toggle button in the toolbar to the default state
function handleHide() {
...
var ShowUndefButtonIcon = function () {
  button.icon = {
    "16": "./icon-16.png",
    "32": "./icon-32.png",
    "64": "./icon-64.png"
...
function resizePanelPrefs() {
  panel.resize(prefs["extensions.imoin.panel.width"], prefs["extensions.imoin.panel.height"]);
}
sp.on("extensions.imoin.panel.width", resizePanelPrefs);
sp.on("extensions.imoin.panel.height", resizePanelPrefs);
resizePanelPrefs();
